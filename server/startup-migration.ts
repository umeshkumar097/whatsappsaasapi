...
const steps: MigrationStep[] = [
  ...
  addColumnIfNotExists("users", "cashfree_customer_id", "VARCHAR"),
  ...
  addColumnIfNotExists("plans", "cashfree_plan_id_monthly", "VARCHAR"),
  addColumnIfNotExists("plans", "cashfree_plan_id_annual", "VARCHAR"),
